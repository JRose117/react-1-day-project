  ...
  return (
    <main className="hero text-center">
      <div className="hero-container">
        ...
        <Link className='btn dark' to="/harrypotter"> Harry Potter </Link>
        <Link className='btn dark' to="/cocktails"> Cocktails </Link>
        <Link className='btn dark' to="/crypto"> Crypto </Link>
